      ...
      <main className="pt-[69px] md:pt-[93px] lg:pt-[101px]">
        <div className="container mx-auto px-4">
          <div className="border-x border-[#262626]">
            ...
            <div className="flex justify-center px-6 md:px-0 py-[30px] md:py-[50px] border-y border-[#262626]">
              <ul className="flex flex-col md:flex-row gap-3 lg:gap-5 xl:gap-[30px] w-full md:w-auto">
                <li>
                  <Link
                    href="mailto:hello@squareup.com"
                    className="flex items-center justify-center md:justify-start bg-[#262626] rounded-lg py-[18px] px-6 gap-3.5 text-[#E6E6E6] lg:text-xl"
                  >
                    <svg
                      width="24"
                      height="25"
                ...
                <li className="flex justify-center md:justify-start items-center bg-[#262626] rounded-lg py-[18px] px-6 gap-3.5 text-[#E6E6E6] lg:text-xl">
                  <svg
                    width="24"
                    height="25"
                    viewBox="0 0 24 25"
            ...
            <Form />
            <div className="flex flex-col md:flex-row justify-center border-y border-[#262626]">
              <div className="flex-1 flex items-center justify-end gap-3.5 p-5 md:p-6 lg:px-10 xl:px-20 border-r border-[#262626] lg:py-[50px]">
                <span className="md:text-lg lg:text-[22px] font-medium text-[#E6E6E6]">
                  Operating Days
                </span>
                <label className="py-2.5 px-5 md:py-3 md:px-4 lg:px-6 bg-[#262626] rounded-sm md:rounded-md text-sm md:text-lg lg:text-xl font-medium text-[#E6E6E6]">
                  Monday to Friday
                </label>
              </div>
              <div className="flex-1 flex items-center pt-5 pb-10 md:p-6 lg:px-10 xl:px-20 lg:py-[31px] border-t border-[#262626] md:border-0">
                <div className="inline-flex flex-col md:flex-row items-center md:border md:border-[#262626] rounded-xl md:p-2 lg:p-3 xl:p-3.5 xl:pl-6 w-full md:w-auto">
                  <h3 className="md:text-lg font-medium mb-5 md:mb-0 md:mr-5 text-[#E6E6E6]">
                    Stay Connected
                  </h3>
                  <ul className="flex gap-2.5 md:gap-3 lg:gap-3.5">
                      ...
                      return (
                        <li key={i}>
                          <Link
                            ...
                            className="w-[52px] md:w-10 lg:w-12 xl:w-16 aspect-square flex items-center justify-center rounded-lg bg-[linear-gradient(180deg,#242424_0%,rgba(36,36,36,0)_100%)]"
                          >
