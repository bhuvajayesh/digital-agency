          ...
          <div className="border-x border-[#262626]">
            <div className="bg-[url(/images/banner-bg.png)] bg-cover bg-center pt-12 md:pt-20 pb-24 md:pb-32 lg:pt-[112px] lg:pb-44 xl:pb-[274px] text-center">
              ...
              <div className="mt-10 mb-10 md:mb-[50px] inline-flex flex-wrap md:flex-nowrap items-center justify-center gap-1.5 p-4 md:p-5 lg:py-6 lg:px-10 bg-[rgba(36,36,36,0.2)] border border-[#262626] rounded-xl">
                <div className="md:text-lg lg:text-[22px] text-[#98989A]">For</div>
                <span className="bg-[#262626] py-2 px-2.5 lg:py-3 lg:px-3.5 rounded-lg md:text-lg lg:text-[22px]">
                  Startups
                </span>
                <div className="md:text-lg lg:text-[22px] text-[#98989A]">,</div>
                <span className="bg-[#262626] py-2 px-2.5 lg:py-3 lg:px-3.5 rounded-lg md:text-lg lg:text-[22px]">
                  Enterprise leaders
                </span>
                <div className="md:text-lg lg:text-[22px] text-[#98989A]">,</div>
                ...
                <div className="md:text-lg lg:text-[22px] text-[#98989A]">and</div>
                <span className="bg-[#262626] py-2 px-2.5 lg:py-3 lg:px-3.5 rounded-lg md:text-lg lg:text-[22px]">
                  Social Good
                </span>
              </div>
            ...
            <Accordion className="custom-accordion grid grid-cols-1 lg:grid-cols-2">
              <div className="lg:py-12 xl:py-20 border-x border-[#262626]">
                {accordionList.slice(0, 4).map((data, i) => (
                  ...
                  >
                    <AccordionItemHeading>
                      <AccordionItemButton>
                        <div className="accordion-head flex items-center gap-2 md:gap-4 lg:gap-6 xl:gap-[30px]">
